import { db, collection, addDoc, getDocs } from "./index.html"; // ya importado globalmente
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.cargarCalendario = async () => {
    ...
    for(let d=1; d<=diasMes; d++){
      ...
      if(turnosDia.length>0) diaDiv.style.backgroundColor="#ffc107"; // amarillo si hay turno
  ...
  formTurno.onsubmit = async e=>{
    ...
    formTurno.reset();
    cargarCalendario(); // actualizar vista de turnos en admin
  };
